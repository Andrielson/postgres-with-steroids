...
FROM ubuntu:noble AS postgres-17-noble
...
# see note below about "*.pyc" files
    ...
    . /etc/os-release; \
	aptRepo="[ signed-by=/usr/local/share/keyrings/postgres.gpg.asc ] http://apt.postgresql.org/pub/repos/apt/ $VERSION_CODENAME-pgdg main $PG_MAJOR"; \
	case "$dpkgArch" in \
		amd64 | arm64 | ppc64el) \
...
### PG DUCKDB BUILDER
###
FROM postgres-17-noble AS pg-duckdb-builder
